...
- 2b520c7: Follow-ups to the bounded chart export work in 5.4.0, from review.
...
- Updated dependencies [2b520c7]
  - @json-to-office/shared@6.1.0
...
- 2000f88: Bound, retry and deduplicate Highcharts export-server requests.
...
- Updated dependencies [88a3683]
- Updated dependencies [d413e25]
...
- 5f4eb73: New bundled DOCX theme `consulting` (#329, DOCX portion): the house style
