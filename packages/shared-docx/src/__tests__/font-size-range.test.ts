 ...
 * no low ceiling — Word's own UI goes to 1638pt. The earlier caps (72pt, then
 * 120pt) rejected legitimate display sizes (cover numerals, chapter headings,
 * pull quotes) that Word renders correctly and that this library emits without
 * clamping.
 *
...
describe('font.size range', () => {
  describe('accepts display type above the old caps', () => {
