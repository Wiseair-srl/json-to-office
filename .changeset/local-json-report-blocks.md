...
Block definitions inherit their format from the document. Generated authoring schemas provide component, plugin-property and binding completion inside block bodies, nested compositions and section chrome. Repeated omission, nested budget metadata, plugin validation errors and partial gallery regeneration are covered by regression tests.
