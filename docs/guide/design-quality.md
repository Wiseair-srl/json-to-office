...
steps), a technical report eight, a consulting deck nine across the deck and six
on its busiest slide; every checkpoint and verification document of that
...
| `consulting-deck`        | PPTX   | Requires `takeaway` and `source` slots, bounds action titles at two lines, at most 90 body words, at most five bullets of at most twelve words in a box, content inside the theme's safe area, every content slide titled, every image with alt text, every size on the theme scale with at most nine in the deck and six on a slide, and every title of one kind on one line                                                                                                                                              |
