...
Both packages require Node >= 22, and both declare their rendering backend as a peer dependency: `docx@9.7.1` for `@json-to-office/json-to-docx`, `pptxgenjs@^3.12.0` for `@json-to-office/json-to-pptx`.
