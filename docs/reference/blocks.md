...
| -------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cover`        | title ≤ 16 words, subtitle ≤ 20, client ≤ 8, date ≤ 6, confidentiality ≤ 6, logo (component)                      | An accent rule from the theme's `cover` recipe, `client · date` in the eyebrow role (the line needs the client), the title in the `title` role stepping down 32 → 28 → 24pt over three lines, the subtitle beneath, the logo (slot role `logo`) top right at 18% of the width in the chrome band, confidentiality at the foot |
| `action-chart` | title (action title) ≤ 17 words, tracker, chart (component), takeaway ≤ 40, source ≤ 24                           | The action title with `fit: { maxLines: 2, shrink: [24, 22] }`, a chart at 68% of the width painted from the theme series, the takeaway beside it under an accent rule, the source beneath a hairline that collapses with it                                                                                                  |
...
| `statement`    | assertion (action title) ≤ 11 words, support ≤ 30, tracker                                                        | A short accent rule, the assertion in the `display` role stepping down 28 → 24 → 22pt over three lines, the support in the `quote` role beneath: a divider or a closing slide                                                                                                                                                 |
