...
| `running-head`   | title ≤ 6 words, tracker ≤ 3, confidentiality ≤ 4, date ≤ 3, pageNumbers                                                                  | Header `title · tracker` and footer `confidentiality · n / N · date` in the tracker and footer roles, inherited by later sections                                                                                                                                                                                                                                     |
