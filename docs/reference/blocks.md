...
| `section-opener` | number, title                                                                                                                             | Eyebrow number and a real level-1 heading                                                                                                                                                                                                                                                                                                                             |
| `running-head`   | title ≤ 6 words, confidentiality ≤ 4, date ≤ 3, pageNumbers                                                                               | Header `title` and footer `confidentiality · n / N · date` in the tracker and footer roles, inherited by later sections, which continue on the page                                                                                                                                                                                                                   |
