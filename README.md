...
- **Theme system**: colors, fonts, spacing, component defaults. 4 built-in DOCX themes (consulting, minimal, devportal, vermilion) and 5 PPTX themes (consulting, dark, minimal, vermilion, devportal) — consulting is the default in both — or define your own.
